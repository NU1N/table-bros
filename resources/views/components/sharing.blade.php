<div class="mt-2 pt-2  flex flex-wrap gap-4 justify-between items-center">
    ...
    <div class="flex items-center gap-1">
        ...
        <div class="flex"
            ...
            <a :href="`https://vk.com/share.php?url=${url}&title=${title}`"  class="m-2 hover:opacity-90">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" width="101" height="100" viewBox="0 0 101 100" fill="none">
            ...
            <a :href="`https://t.me/share/url?url=${url}&text=${title}`" class="m-2 hover:opacity-90">
                <svg class="w-8 h-8"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="1000px" height="1000px" viewBox="0 0 1000 1000" version="1.1">
